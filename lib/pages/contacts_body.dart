...
class _ContactsBodyState extends State<ContactsBody> {
  ...
  final List<AppContact> list = [
    AppContact(cId: "0", cImage: "assets/user.png", cType: "My Contacts", cNumber: "01757261840", cName: "Mostafijur Rahman"),
    AppContact(cId: "0", cImage: "assets/user.png", cType: "My Contacts", cNumber: "01757261840", cName: "Mostafijur Rahman"),

    AppContact(cId: "0", cImage: "assets/user.png", cType: "Recents", cNumber: "01123456789", cName: "Tony Stark"),
    AppContact(cId: "0", cImage: "assets/user.png", cType: "Recents", cNumber: "01123456789", cName: "Pantu Chudir vai"),
    AppContact(cId: "0", cImage: "assets/user.png", cType: "Recents", cNumber: "01123456789", cName: "Tawuf Chudir vai"),
